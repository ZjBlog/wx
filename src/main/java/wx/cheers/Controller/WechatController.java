...
public class WechatController {
    ...
    public String authGet(@RequestParam(name = "signature", required = false) String signature,
        ...
        if (StringUtils.isAnyBlank(signature, timestamp, nonce,
                echostr)) { throw new IllegalArgumentException("请求参数非法，请核实!"); }
    ...
    public String post(@RequestBody String requestBody, @RequestParam("signature") String signature,
        ...
        if (!this.wxService.checkSignature(timestamp, nonce,
                signature)) { throw new IllegalArgumentException("非法请求，可能属于伪造的请求！"); }
